    ...
    <div className={signupStyles.pageContainer}>
      <div className={signupStyles.cardContainer}>
        ...
        <div className={signupStyles.formContainer}>
          ...
          <form onSubmit={handleSubmmit} noValidate>
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.input} ${errors.name ? "border-red-400" : "border-gray-300"}`}
                  placeholder="Suman Raul"
                />
              </div>
              {errors.name && (
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.input} ${errors.email ? "border-red-400" : "border-gray-300"}`}
                  placeholder="your@examl.com"
                />
              </div>
              {errors.email && (
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.passwordInput} ${errors.password ? "border-red-400" : "border-gray-300"}`}
                  placeholder="******"
                />
                <button
                  type="button"
