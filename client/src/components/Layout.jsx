...
// to filer the transactions based on the category
...
const Layout = ({ onLogout, user, setUser }) => {
  ...
  // to fetch the transactions data from server side
  ...
  // to add the transactions to the database
  ...
  // to edit the transactions in the database
  ...
  // to delete the transactions from the database
  ...
  ); //filter the transactions based on the time frame selected by the user and memoize the result to optimize performance

  // get stats data for the dashboard and memoize the result to optimize performance
  ...
  return (
    <div className={styles.layout.root}>
      <Navbar onLogout={onLogout} user={user} setUser={setUser} />
      <Sidebar
        user={user}
